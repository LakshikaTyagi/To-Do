...
function Important(props) {
  ...
  return (
    <div className={`${!props.open && "hidden"} h-screen flex flex-col text-blue-500`}
    >
      <div className='flex justify-between items-center my-4 mx-6 text-[20px]'>
        <div className='flex items-center'>
          <div className='py-1.5 px-2 flex items-center'>
            ...
            <div className='ml-2 text-blue-500 '>Important</div>
          </div>
