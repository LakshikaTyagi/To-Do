      ...
      <div className='flex justify-between items-center'>
        <div className='flex'>
          <div className='py-1.5 px-2 flex'>
            ...
            <div className='ml-2 text-blue-500 text-xl'>Important</div>
          </div>
          <div className='p-1 ml-0.5'>
            <button>...</button>
          </div>
          <div className='py-2 px-3 ml-1.5 flex'>
          ...
          <div className='py-2 px-3 ml-1.5 flex'>
            ...
            <div className='ml-2 text-[#2564CF]'>List</div>
          </div>
        </div>
        <div className='py-0.5 px-3 ml-1 right-0 flex'>
