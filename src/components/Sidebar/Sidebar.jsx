    ...
    <div className='flex w-full'>
      ...
      <div className='flex flex-col relative box-border h-screen p-0 w-73 top-0 left-0 border border-r-red-400'>
        ...
        <div className='overflow-y-auto overflow-x-hidden'>
          <Link to="/" className='py-3 px-6 flex text-[#292827] '>
          ...
          <Link to="/important" className='py-3 px-6 flex text-[#292827]'>
          ...
          <Link to="/planned" className='py-3 px-6 flex text-[#292827]' >
          ...
          <Link to="/assigned" className='py-3 px-6 flex text-[#292827]'>
          ...
          <Link to="tasks" className='py-3 px-6 flex text-[#292827]'>
